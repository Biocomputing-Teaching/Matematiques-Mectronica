...
\tdplotsetcoord{C}{\rvec}{\thetavec + \dthetavec}{\varphivec + \dphivec}
\tdplotsetcoord{D}{\rvec}{\thetavec}{\varphivec + \dphivec}
%
...
\tdplotsetcoord{G}{\rvec + \drvec}{\thetavec + \dthetavec}{\varphivec + \dphivec}
\tdplotsetcoord{G'}{\rvec + \drvec}{90}{\varphivec + \dphivec}
\tdplotsetcoord{H}{\rvec + \drvec}{\thetavec}{\varphivec + \dphivec}
%%%Nodes
%\node at (A) {A};
%\node at (B) {B};
%\node at (C) {C};
...
\begin{pgfonlayer}{foreground}
	...
	\tdplotsetthetaplanecoords{\varphivec+\dphivec}
	\tdplotdrawarc[tdplot_rotated_coords, dashed]{(O)}{\rvec}{\thetavec+\dthetavec}{90}{}{}
	\tdplotdrawarc[tdplot_rotated_coords]{(O)}{\rvec+\drvec}{\thetavec+\dthetavec}{90}{}{}
	%
	\tdplotdrawarc[tdplot_main_coords]{(O)}{\rvec}{\varphivec}{\varphivec+\dphivec}{}{}
	\node[rotate=13] at (3,4.45,0) {$r\sin\theta\mathrm{d}\varphi$};
	\tdplotdrawarc[tdplot_main_coords]{(O)}{\rvec+\drvec}{\varphivec}{\varphivec+\dphivec}{}{}
\end{pgfonlayer}
